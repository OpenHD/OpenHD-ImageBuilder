...
function install_radxa-debian_packages_rk3566 {
    ...
    PLATFORM_PACKAGES="rockchip-iq-openhd-r3 mpp-rk3566 fpv-rk3566 camera-engine-rkaiq"
    ...
    # PLATFORM_PACKAGES="dialog pv net-tools isc-dhcp-client network-manager glances rockchip-iq-openhd-r3 librga2=2.2.0-1 procps"
}
