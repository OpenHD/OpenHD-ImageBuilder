...
function install_radxa-debian_packages_rk3566 {
    ...
    PLATFORM_PACKAGES="dnsmasq dialog pv gst-latest net-tools isc-dhcp-client network-manager glances rockchip-iq-openhd librga2=2.2.0-1 procps camera-engine-rkaiq"
