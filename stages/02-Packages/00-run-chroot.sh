...
function install_raspbian_packages {
    ...
    PLATFORM_PACKAGES="firmware-atheros firmware-misc-nonfree openhd-userland openhd-linux-pi openhd-linux-pi-headers libseek-thermal libcamera-openhd openhd-qt qopenhd openssh-server"
}
