...
if [ ! -e emmc ]; then
    ...
    apt update
    PLATFORM_PACKAGES_REMOVE="gnome* libcups2 libgstreamer* libopencv* libqt5* xserver* codium firefox* dkms *sddm* plymouth plasma-desktop kde* lightdm *xfce* chromium"
