...
function install_radxa-debian_packages_rk3566 {
    ...
    BASE_PACKAGES="linux-headers-5.10.160-radxa-rk356x linux-image-5.10.160-radxa-rk356x openhd-sys-utils openhd qopenhd-rk3566 apt-transport-https apt-utils open-hd-web-ui"
