...
function install_raspbian_packages {
    ...
    PLATFORM_PACKAGES="openhd-linux-pi=2.5-evo-02261110-de50a0476 firmware-atheros openhd-userland libseek-thermal libcamera-openhd openhd-qt openssh-server 88x2bu-rpi"
}
