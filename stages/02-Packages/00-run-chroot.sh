...
function install_radxa-debian_packages {
    ...
    PLATFORM_PACKAGES="rockchip-iq-openhd linux-headers-5.10.110-99-rockchip-g73c6dbeaf linux-image-5.10.110-99-rockchip-g73c6dbeaf rsync qopenhd procps mpv camera-engine-rkaiq"
}
