...
if [[ "${OS}" == "raspbian" ]]; then
    ...
    PLATFORM_PACKAGES="veye-raspberrypi libavcodec-dev libavformat-dev mavsdk gst-plugins-good openhd-qt qopenhd libsodium-dev libpcap-dev git nano libcamera0 openssh-server libboost1.74-dev libboost-thread1.74-dev meson"
fi
