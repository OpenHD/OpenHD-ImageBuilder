...
function install_radxa-debian_packages_rk3566 {
    ...
    PLATFORM_PACKAGES="dialog pv net-tools isc-dhcp-client network-manager glances rockchip-iq-openhd-r3 librga2=2.2.0-1 procps camera-engine-rkaiq mpp-rk3566 linux-image-5.10.160-radxa-rk356x=5.10.160-radxa-2024-03-06-17-14--3867a376e"
