...
function install_radxa-debian_packages_rk3566 {
    ...
    PLATFORM_PACKAGES_HOLD="librga linux-headers-radxa-zero3 linux-image-radxa-zero3 task-rk356x task-rockchip radxa-system-config-rockchip task-radxa-cm3-rpi-cm4-io radxa-firmware"
