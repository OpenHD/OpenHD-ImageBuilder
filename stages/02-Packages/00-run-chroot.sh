...
function install_radxa-debian_packages {
    ...
    PLATFORM_PACKAGES="rockchip-iq-openhd linux-headers-5.10.110-99-rockchip-g69ecce98b linux-image-5.10.110-99-rockchip-g69ecce98b rsync qopenhd procps mpv camera-engine-rkaiq"
}
