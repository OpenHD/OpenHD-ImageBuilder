...
if [[ "${OS}" == "raspbian" ]]; then
 ...
 if [[ "${OS}" == "ubuntu-x86" ]] ; then
        ...
        sudo apt-mark hold linux-image-generic linux-headers-generic linux-headers-5.15.0-48-generic linux-hwe-5.15-headers-5.15.0-48 linux-image-5.15.0-48-generic linux-modules-5.15.0-48-generic linux-modules-extra-5.15.0-48-generic
        sudo apt update
        sudo apt upgrade
