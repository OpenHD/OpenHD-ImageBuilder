...
#!/bin/bash
 ...
 if [[ "${OS}" == "ubuntu-x86" ]] ; then
        ...
        #install all qt-dependencies (needs to be cleaned in the future)
            ...
            apt -y install mono-complete mono-runtime libmono-system-windows-forms4.0-cil libmono-system-core4.0-cil libmono-system-management4.0-cil libmono-system-xml-linq4.0-cil
         mkdir -p /opt/X86/
