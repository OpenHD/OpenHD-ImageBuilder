...
function install_raspbian_packages {
    ...
    PLATFORM_PACKAGES="openhd-linux-pi=2.5-evo-10111405-20cb6d7b533b firmware-atheros openhd-userland libseek-thermal libcamera-openhd openhd-qt openssh-server 88x2bu-rpi"
}
