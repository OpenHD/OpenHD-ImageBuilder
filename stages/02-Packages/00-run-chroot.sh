...
if [[ "${OS}" == "raspbian" ]] || [[ "${OS}" == "raspbian-legacy" ]]; then
    ...
    apt remove -y nfs-common
        ...
        PLATFORM_PACKAGES="mavsdk gst-plugins-good openhd-linux-pi veye-raspberrypi openhd-qt-pi-bullseye qopenhd libsodium-dev libpcap-dev git nano libcamera0 openssh-server libboost1.74-dev libboost-thread1.74-dev meson"
